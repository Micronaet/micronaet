...
path="~/ETL/servizi"
config.read([path + 'openerp.cfg']) # if file is in home dir add also: , os.path.expanduser('~/.openerp.cfg')])
...
for contract in sock.execute(dbname, uid, pwd, 'account.analytic.account', 'search', [('code','=',False)]) 
   print contract['name']
