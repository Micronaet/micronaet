<html>
  <head>
    <title>GPB Stato materiali</title>
    <style type="text/css">
<!--
<?php 
...
<table width="<?php echo $b_table_w; ?>" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
 ...
 <td height="20"><span class="style9"><a href="cerca.php">Ricerca:</a></span></td>
 <td height="30" colspan="5" align="left"><span class="style9">Cod.:<?php echo strtoupper($_GET["codice"]); ?><br>
 ...
 <tr align="center" bgcolor="#003366">
  ...
  <td height="20"><span class="style13">In arrivo</span></td>
  <td height="20"><span class="style13">Prenotato</span></td>
...
echo "<tr bgcolor='#003366'><td colspan='6' height='20'><span class='style13'>Record trovati: $cont</span></td></tr>";
fclose ($fd);?>
</table>
</body>
<html>
