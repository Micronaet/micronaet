...
smtp_log=config.get('smtp','log_file') + ".partner." + sys.argv[1][-3:] + "." + sys.argv[2].lower() + ".csv"
smtp_sender=config.get('smtp','sender') 
smtp_receiver=config.get('smtp','receiver') 
smtp_text=config.get('smtp','text') 
smtp_subject=config.get('smtp','subject') + " partner per azienda: " + sys.argv[1][-3:] + " tipo import: " + sys.argv[2].lower() 
