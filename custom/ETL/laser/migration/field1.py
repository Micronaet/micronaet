...
dbname=config.get('dbaccess1','dbname')
user=config.get('dbaccess1','user')
pwd=config.get('dbaccess1','pwd')
server=config.get('dbaccess1','server')
port=config.get('dbaccess1','port')   # verify if it's necessary: getint
