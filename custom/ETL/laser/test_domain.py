...
tabella='res.partner'
tabella_id = sock.execute(dbname, uid, pwd, tabella, 'search', [('name','not ilike','rio')]) 
tabella_res = sock.execute(dbname, uid, pwd, tabella, 'read', tabella_id) 

i=0
for item in tabella_res:
    i+=1
