...
print sock.execute(dbname, uid, pwd, 'sale.order.line', 'fields_view_get', False, 'form')['arch']
#print sock.execute(dbname, uid, pwd, 'res.partner', 'fields_view_get', False, 'form')['arch']
