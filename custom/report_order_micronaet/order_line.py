...
class sale_order_add_fields(osv.osv):
    _name='sale.order'
    _inherit='sale.order'
    
    _columns={
              'has_master_header': fields.boolean('Intestazione tabella principale', required=False, help="Nei preventivi di sola comunicazione evita l'inserimento intestazione"),

             }
sale_order_add_fields()
