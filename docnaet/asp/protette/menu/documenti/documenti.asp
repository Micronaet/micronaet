...
<!--#include virtual="/docnaet/librerie/codice/testo.asp" -->
...
%>
  <tr bgcolor=<%=colore%>> 
     <td width="90" align="left">
         <a href="modifica.asp?ID_documento=<%=Documenti.Fields.Item("ID_documento").Value%>&ID_cliente=<%=Documenti.Fields.Item("ID_cliente").Value%>"><img src="../../../../immagini/sistema/bottoni/open.gif" width="18" height="21" border="0"></a>
         <a href="file://<%=getNomeFile(Documenti.Fields.Item("ID_documento"),Documenti.Fields.Item("ID_protocollo"),Session("IDDitta"),Documenti.Fields.Item("ID_supporto"),Documenti.Fields.Item("docFile"),Documenti.Fields.Item("docEstensione"), Puntatore)%>" target="_blank"><img src="../../../../immagini/sistema/logo/documenti/ie.gif" width="20" height="20" border="0"></a>
         <a href="docnaet://<%=getNomeFileDocnaet(Documenti.Fields.Item("ID_documento"),Documenti.Fields.Item("ID_protocollo"),Session("IDDitta"),Documenti.Fields.Item("ID_supporto"),Documenti.Fields.Item("docFile"),Documenti.Fields.Item("docEstensione"), Puntatore)%>"> <img src="<%=GetImmagine(Documenti.Fields.Item("docEstensione").value, Puntatore)%>" width="20" height="20" border="0"></a>
         <% if Documenti.Fields.Item("docScadenza").Value then %>
             <img src="../../../../immagini/sistema/bottoni/allarme.png" width="20" border="0" title="Promemoria: <%=Documenti.Fields.Item("docScadenza").Value%>">                   
         <% end if %>
     </td>
     <td width="10%"> 
