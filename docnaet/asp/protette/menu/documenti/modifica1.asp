...
<!--#include virtual="/docnaet/librerie/codice/icone.asp" -->
...
If (CStr(Request("MM_update")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "txtDocMotivo|value|cboID_tipologia|value|txtDocData|value|txtDocScadenza|value|txtDocNumero|value|txtDocFax|value|cboID_lingua|value|txtDocOggetto|value|txtDocDescrizione|value|txtDocNote|value|cboID_cliente|value|select|value|txtDocAccesso|value"
  MM_columnsStr = "docMotivo|',none,''|ID_tipologia|none,none,NULL|docData|',none,NULL|docScadenza|',none,NULL|docNumero|none,none,NULL|docFax|none,none,NULL|ID_lingua|none,none,NULL|docOggetto|',none,''|docDescrizione|',none,''|docNote|',none,''|ID_cliente|none,none,NULL|ID_prodotto|none,none,NULL|docAccesso|none,none,NULL"
...
DettaglioDoc.Source = "SELECT * FROM Documenti WHERE ID_documento = " + DettaglioDoc__MMColParam 
...
if isnull(DettaglioDoc.Fields.Item("ID_utente").Value) then
   Valore="0"
else 
   Valore=Cstr(DettaglioDoc.Fields.Item("ID_utente").Value) ' testare per valori null
end if

set getUtente = Server.CreateObject("ADODB.Recordset")
getUtente.ActiveConnection = MM_SQLDocnaet_STRING
getUtente.Source = "SELECT uteDescrizione FROM Utenti WHERE ID_utente = " + Valore
getUtente.CursorType = 0
getUtente.CursorLocation = 2
getUtente.LockType = 3
getUtente.Open()
if getUtente.eof then
   gUtente="Non trovato"
else
   gUtente=getUtente.Fields.Item("uteDescrizione").Value   
end if
%>
<html>
<head>
...
<%
   dim NomeFilePuntato, Puntatore, NomeFileBatch
...
' *********************** parte nuova per la creazione del file batch *************************   
   ' NomeFileBatch=getNomeFileBatch(DettaglioDoc.Fields.Item("ID_documento"),DettaglioDoc.Fields.Item("ID_protocollo"),Session("IDDitta"),DettaglioDoc.Fields.Item("ID_supporto"),DettaglioDoc.Fields.Item("docFile"),DettaglioDoc.Fields.Item("docEstensione"), Puntatore)
%>
...
%>
    ...
    <tr> 
          ...
          <td colspan="4" bgcolor="#CEECFD"> &nbsp; 
               ...
               Autore: <b><font color="#990000"><%=gUtente%></font></b></td>
    </tr>
    <tr> 
          <td width="12%" bgcolor="#FFFFCC"><b>Scadenze e avvisi:</b></td>
          <td colspan="4" bgcolor="#CEECFD">
               &nbsp; scadenza: <input value="<%=DettaglioDoc.Fields.Item("docScadenza").Value%>" type="text" name="txtDocScadenza" size="14">
               &nbsp; motivo:   <input value="<%=DettaglioDoc.Fields.Item("docMotivo").Value%>" type="text" name="txtDocMotivo" size="16" maxlength="16">
          </td>
    </tr>

    <tr bgcolor="#999999" align="center"> 
      <td colspan="3">&nbsp; </td>
      <td width="30" bgcolor="#CEECFD"> 
...
<table width="100%" border="0" height="58">
  <tr bgcolor="#CEECFD" align="center"> 
    <td width="68" valign="middle" align="center">
        <a href="<%=NomeFilePuntato%>" target="_blank"><img src="<%=GetImmagine(DettaglioDoc.Fields.Item("docEstensione").value, Puntatore)%>" width="20" height="20" border="0" alt="Apri documento..." name="imgNuovo"></a>       
        <br/>
        <a href="docnaet://<%=getNomeFileDocnaet(DettaglioDoc.Fields.Item("ID_documento"),DettaglioDoc.Fields.Item("ID_protocollo"),Session("IDDitta"),DettaglioDoc.Fields.Item("ID_supporto"),DettaglioDoc.Fields.Item("docFile"),DettaglioDoc.Fields.Item("docEstensione"), Puntatore)%>"> <img src="<%=GetImmagine(DettaglioDoc.Fields.Item("docEstensione").value, Puntatore)%>" width="20" height="20" border="0"></a>
    </td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr bgcolor="#CEECFD"> 
            ...
            <td width="83%"> <font color="#333333"> 
              ...
              Ricarica intestazione</font> <font color="#333333"> 
              <% else %>
              Intestazione non gestita</font> <font color="#333333"> 
              <% end if %>
              </font></td>
          </tr>
          <tr> 
            <td width="83%" bgcolor="#CEECFD"> <font color="#333333"> 
              ...
              Prot. fax</font> <font color="#333333"> 
              <% else %>
              Già assengato il fax</font> <font color="#333333"> 
              <% end if %>
              </font></td>
          </tr>
        </table>
    ...
    <form name="frmDuplica" method="post" action="operazioni.asp" target="_parent">
      <td width="309" valign="middle"> 
        <table width="100%" border="0" height="100%" cellpadding="0" cellspacing="0">
          <tr bgcolor="#CEECFD" bordercolor="#999999"> 
