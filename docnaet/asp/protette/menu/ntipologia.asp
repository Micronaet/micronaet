...
If (CStr(Request(MM_flag)) <> "") Then
  ...
  MM_dupKeySQL="SELECT tipDescrizione FROM Tipologie WHERE tipDescrizione='" & MM_dupKeyUsernameValue & "'"
...
<form name="frmInserimento" method="POST" action="<%=MM_editAction%>">
   <div align="center">
    <table width="28%" border="0" bgcolor="#CCCCCC">
      <tr>
      <td align="center"> <b><font color="#009933">Inserimento Tipologia</font></b> 
      </td>
    </tr>
  </table> </div> <br> 
  <table width="28%" border="0" align="center">
    <tr> 
      <td width="26%" bgcolor="#FFFFCC">Tipologia:</td>
      <td width="74%" bgcolor="#CEECFD"> 
        <input type="text" name="txtDescrizione">
      </td>
    </tr>
    <tr> 
      <td width="26%" bgcolor="#FFFFCC">Note:</td>
      <td width="74%" bgcolor="#CEECFD"> 
