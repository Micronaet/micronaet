...
<table width="100%" border="0" height="52">
  <tr bgcolor="#999999"> 
    <td colspan="4"> 
      <div align="center"><b><font color="#FFFFCC">Inserimento Prodotto</font></b></div>
    </td>
  </tr>
</table>
<br>
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="frmUpdate">
  <table width="69%" border="0" align="center" height="71">
    <tr bgcolor="#CCCCCC"> 
      <td colspan="5"> 
        <div align="center"><b><font color="#990000">Nuovo Prodotto</font></b></div>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td bgcolor="#FFFFCC" width="87%"> 
        <div align="left"> 
          <input  type="text" name="txtDescrizione" size="50">
        </div>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
%>
          <option value="<%=(Clienti.Fields.Item("ID_cliente").Value)%>"><%=(Clienti.Fields.Item("cliRagioneSociale").Value)%></option>
          <%
  Clienti.MoveNext()
Wend
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td bgcolor="#FFFFCC" width="87%">
        <input  type="text" name="txtNote" size="50">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="13%" bgcolor="#CEECFD">Codifica</td>
      <td bgcolor="#FFFFCC" width="87%"> 
        <input type="text" name="txtCodifica" size="20">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
