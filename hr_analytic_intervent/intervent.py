...
class hr_analytic_timesheet_intervent(osv.osv):
    ...
    def onchange_partner_id(self, cr, uid, ids, partner_id, context=None):
        """ Set account domain depend on partner
        """
        res = {}
        res['value'] = {}
        res['domain'] = {}
    ...
    _columns = {
        ...
        # 'invoice_intervent': fields.boolean('Intervent to invoice',
        # required = False,
        #    help = 'If the intervent is to be invoiced, used for filter
        #    elements'),
        'invoice_costs': fields.boolean(
            'Cost to invoice', required=False,
