...
function validateForm(Oggetto) { //v4.0
    if (!Oggetto.value) 
	{
	   alert ('Inserire necessariamente il nome del tipo cliente!');
	   return false;
    }
	else 
	{
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="frmInserimento">
   <div align="center">
    <table width="28%" border="0" bgcolor="#CCCCCC">
      <tr>
        <td align="center"> <b><font color="#009933">Modifica Tipo Cliente</font></b> 
        </td>
    </tr>
  </table> </div> <br>
    ...
    <tr> 
      ...
      <td width="77%" bgcolor="#CEECFD"> 
        <input value="<%=(Tipi.Fields.Item("tipDescrizione").Value)%>" type="text" name="txtDescrizione">
        <input type="hidden" name="hiddenField" value="<%=(Tipi.Fields.Item("ID_tipo").Value)%>">
      </td>
    </tr>
    <tr> 
      <td width="23%" bgcolor="#FFFFCC">Note:</td>
      <td width="77%" bgcolor="#CEECFD"> 
        <input value="<%=(Tipi.Fields.Item("tipNote").Value)%>" type="text" name="txtNote">
      </td>
    </tr>
  </table>
  <div align="center"><br>
  ...
  <table width="28%" border="0" align="center">
    <tr bgcolor="#CCCCCC"> 
      ...
      <td align="center"> 
        <input type="button" name="Submit3" value="Annulla" onClick="goToURL('tipi.asp');return false">
      </td>
    </tr>
  </table>
