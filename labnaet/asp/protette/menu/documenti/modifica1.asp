...
getUtente.Source = "SELECT uteDescrizione FROM Utenti WHERE ID_utente = " + Cstr(DettaglioDoc.Fields.Item("ID_utente").Value) ' testare per valori null
...
<table width="100%" border="0" height="58">
  <tr bgcolor="#CEECFD" align="center"> 
    <td width="68" valign="middle" align="center"> <a href="<%=NomeFilePuntato%>" target="_blank"><img src="<%=GetImmagine(DettaglioDoc.Fields.Item("docEstensione").value, Puntatore)%>" width="20" height="20" border="0" alt="Apri documento..." name="imgNuovo"></a> 
      <br>
      <a href="file://<%=NomeFileBatch%>"><img src="../../../../immagini/sistema/bottoni/icon-books.gif" width="22" height="22" border="0" alt="Apre il documento con il programma originale"></a> 
    </td>
