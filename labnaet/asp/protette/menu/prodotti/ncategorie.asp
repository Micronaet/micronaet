...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_fieldsStr  = "txtDescrizione|value|txtNote|value|hiddenField|value"
  MM_columnsStr = "catDescrizione|',none,''|catNote|',none,''|ID_ditta|none,none,NULL"
...
<form name="frmInserimento" method="POST" action="<%=MM_editAction%>">
  <div align="center"> 
    <table width="28%" border="0" bgcolor="#CCCCCC">
      <tr> 
        <td align="center"> <b><font color="#009933">Nuova Categorie</font></b></td>
      </tr>
    </table>
  </div>
  <br>
  <table width="28%" border="0" align="center">
    <tr> 
      <td width="23%" bgcolor="#FFFFCC">Categoria:</td>
    ...
    <tr> 
      ...
      <td width="77%" bgcolor="#CEECFD"> 
        ...
        <input type="hidden" name="hiddenField" value="<%=Session("IDDitta")%>">
      </td>
    </tr>
  </table>
  <br>
