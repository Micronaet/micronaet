...
# Mail:
smtp = {
    'to': config.get('smtp', 'load_to'),
    'text': '''
        <p>Spett.li responsabili di produzione,</p>
        ...
        <p>questa &egrave; una mail automatica giornaliera inviata da 
            ...
            <b>Rosso</b>: Non trovate produzioni quindi manca la linea da usare
               <br/>
            <b>Giallo</b>: Agganciato a produzione per&ograve; non totalmente 
                pianificata<br/>
            <b>Blue</b>: Agganciato a produzione totalmente pianificata<br/>            
        </p>
        <p>
        ...
        <b>Micronaet S.r.l.</b>
        ''' % now,
    'subject': 'Report %s: Carico linea in base a ordinato' % now,
