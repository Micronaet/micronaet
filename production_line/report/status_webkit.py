...
class report_webkit_html(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            ...
            'get_history_supplier_orders': self._get_history_supplier_orders,
    ...
    def _start_up(self, data=None):
        ...
        """
        return self.pool.get('mrp.production')._start_up(
    ...
    def _get_history_supplier_orders(self):
        """ Supplier order (generated by _start_up function)
        """
        return self.pool.get('mrp.production')._get_history_supplier_orders()
