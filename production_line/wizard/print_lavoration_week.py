...
class mrp_print_lavoration_week__wizard(osv.osv_memory):
    ...
    _defaults = {
        ...
        'from_date': lambda s, cr, uid, c: s.default_date_from_to(
            cr, uid, 'from_date', context=c),
        'to_date': lambda s, cr, uid, c: s.default_date_from_to(
            cr, uid, 'to_date', context=c),
        'week': lambda s, cr, uid, c: s.default_date_from_to(
