...
class sale_order_override(osv.osv):
    ...
    def print_quotation(self, cr, uid, ids, context=None):        
        ...
        '''
        result = super(sale_order_override, self).print_quotation(cr, uid, ids, context=context)

        datas=result.get('datas',{})
        return {'type': 'ir.actions.report.xml', 'report_name': 'crm_quotation_report', 'datas': datas, 'nodestroy': True}
